...
// WordPress dashboard.                                           //
// ===============================================================//
if ( file_exists('/nfco/www/wp/wp-content/plugins/ninjafirewall/lib/firewall.php') ) {
	@include_once '/nfco/www/wp/wp-content/plugins/ninjafirewall/lib/firewall.php';
}
// EOF
